...
class FlashSalesPage extends StatefulWidget {
  const FlashSalesPage({Key? key}) : super(key: key);
                        ...
                        children: [
                          ...
                          ElevatedButton(
                              onPressed: () async {
                                ...
                                await FirebaseDatabase.instance.ref('Flash List').push().set(model.toJson()).then((value) => {
                                  EasyLoading.showSuccess('Done'),
                                  ref.refresh(flashProvider),
