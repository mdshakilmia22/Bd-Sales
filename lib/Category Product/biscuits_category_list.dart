...
class BiscutCategoryList extends StatefulWidget {
  const BiscutCategoryList({Key? key}) : super(key: key);

  @override
  State<BiscutCategoryList> createState() => _BiscutCategoryListState();
}

class _BiscutCategoryListState extends State<BiscutCategoryList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Biscuits',style: TextStyle(color: Colors.black),),
      ),
      body: Consumer(
          builder: (_,ref,watch){
            AsyncValue<List<BiscuitsModel>> flash= ref.watch(biscuitsProvider);
            return flash.when(
                data: (detail){
