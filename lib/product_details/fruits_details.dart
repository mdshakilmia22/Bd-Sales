...
class FruitsDetails extends StatefulWidget {
  const FruitsDetails({super.key, required this.fruitInformation});
  final FruitsModel fruitInformation;
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              SizedBox(height: 10,),
              Text(widget.fruitInformation.title.toString(),style: const TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
              SizedBox(height: 30,),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.network(widget.fruitInformation.pictureUrl.toString(),height: 200,width: 200,)
                ],
              ),
              Row(
                children: [
                  Text('${widget.fruitInformation.price} | ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                  Text(widget.fruitInformation.weight,style: const TextStyle(fontSize: 16),)
                ],
              ),
              SizedBox(height: 15,),
              Row(
              ...
              SizedBox(height: 10,),
              Text(widget.fruitInformation.description.toString(),),
            ],
          ),
        ),
      ),
